...
Le package `evalSaguenay` contient les codes nécessaires pour compléter
l’évaluation des stocks de la pêche récréative hivernale sur le
Saguenay.

0)  La fonction `lire_pre2021()` permet de mettre lire les différentes
    sources et mettre ensemble les données pré-2021.
...
pak::pak("mathieu-desgagnes/evalSaguenay")
```
